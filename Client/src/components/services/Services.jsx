  ...
  return (
    <>
      <section className='services '>
        ...
        <br/>
<p> 2. Housekeeping: Enjoy a clean and tidy environment with our regular housekeeping services. Our dedicated staff ensures that all common areas and facilities are well-maintained to enhance your living experience.
</p>
<br/>
